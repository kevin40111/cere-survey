...
.directive('surveyInput', function($compile, surveyFactory) {
    return {
        ...
        controller: function($scope, $attrs) {
            ...
            var oldAnswer = surveyFactory.answers[$scope.question.id] || surveyFactory.answers[$scope.question.name] ? surveyFactory.answers[$scope.question.id] || surveyFactory.answers[$scope.question.name] : null;
