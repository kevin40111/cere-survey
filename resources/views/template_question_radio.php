<md-radio-group ng-model="answers[question.id]" ng-disabled="node.saving" survey-input parent="answers[question.id]" ng-repeat="question in node.questions" ng-change="saveAnswer(answer, answers[question.id])">
